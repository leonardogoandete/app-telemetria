...
echo "   Grafana: http://192.168.0.100:30300 (NodePort) ou http://localhost:3000 (se usando port-forward)"
...
echo "   Grafana via NodePort: http://192.168.0.100:30300"
echo "   Grafana via port-forward: kubectl port-forward svc/grafana-service 3000:3000"
echo ""
echo "📋 Para ver os logs:"
echo "   kubectl logs -l app=app-a -f"
echo "   kubectl logs -l app=prometheus -f"
echo "   kubectl logs -l app=grafana -f"
echo ""
echo "🔧 KEDA e Auto-scaling:"
echo "   kubectl get scaledobjects"
echo "   kubectl describe scaledobject app-a-predictkube" 
echo "   kubectl logs -n keda-system -l app=keda-operator -f"
echo ""
echo "🧪 Executar testes de carga:"
echo "   k6 run src/load-test.js"
echo "   k6 run src/realistic-load.js"
